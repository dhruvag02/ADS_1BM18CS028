...
list<Node*> insertATreeHeap(list<Node*> _heap, Node* tree)
{
    list<Node*> temp;
    temp.push_back(tree);
...
list<Node*> insert(list<Node*> _heap, int keyVal)
{
    Node* temp=newNode(keyVal);
    return insertATreeHeap(_heap, temp);
}
...
int main()
{
    ...
    //Delete minimum element of heap using extractMin function
